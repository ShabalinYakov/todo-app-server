...
async function up(knex) {
    ...
    CREATE OR REPLACE FUNCTION get_tasks_subordinate (leader_id UUID, subordinate_id UUID) RETURNS TABLE(
      id UUID,
      title VARCHAR,
      description TEXT,
      deadline TEXT,
      ...
      WHERE c.user_id = leader_id AND r.user_id = subordinate_id
...
async function down(knex) {
    return await knex.raw(`DROP FUNCTION get_tasks_subordinate;`);
}
exports.down = down;
//# sourceMappingURL=get_tasks_subordinate.js.map